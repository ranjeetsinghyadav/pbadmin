							...
							<form class="form-horizontal">
									...
									<span class="toggle-demo"> <span>Styles: </span> <span
										class="btn-group btn-group-justified" data-toggle="buttons">
											<label class="btn btn-default btn-xs active"> <input
												type="radio" name="demo-switcher-1" id="style-0"> 1
										</label> <label class="btn btn-default btn-xs"> <input
												type="radio" name="demo-switcher-1" id="style-1"> 2
										</label> <label class="btn btn-default btn-xs"> <input
												type="radio" name="demo-switcher-1" id="style-2"> 3
										</label> <label class="btn btn-default btn-xs"> <input
												type="radio" name="demo-switcher-1" id="style-3"> 4
										</label>
									</span>
									</span>
									<div class="form-group">
								...
								<fieldset class="demo-switcher-1">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<div class="radio">
												<label> <input type="radio" class="radiobox style-0"
													checked="checked" name="style-0"> <span>Radiobox
														1</span>
												</label>
											</div>
											<div class="radio">
												<label> <input type="radio" class="radiobox style-0"
													name="style-0"> <span>Radiobox 2</span>
												</label>
											</div>
											<div class="radio">
												<label> <input type="radio" class="radiobox style-0"
													name="style-0"> <span>Radiobox 3</span>
												</label>
											</div>
										</div>
									</div>
												...
												<div class="col-sm-12">
													<div class="input-group">
														<span class="input-group-addon">@</span> <input
															class="form-control" id="prepend" placeholder="Username"
															type="text">
													</div>
												</div>
											</div>
													...
													<div class="input-group">
														<span class="input-group-addon"> <span
															class="radio"> <label> <input type="radio"
																	class="radiobox style-0" name="style-0a2"> <span>
																		Left</span>
															</label>
														</span>
														</span> <input class="form-control" placeholder="" type="text">
												...
												<div class="col-sm-12">
													...
													<div class="input-icon-left">
														<i class="fa fa-microphone"></i> <input
															class="form-control" placeholder="Left Icon" type="text">
													</div>
							...
							<form class="form-horizontal">
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<input class="form-control" disabled="disabled"
												placeholder="Type somethine..." type="text" list="list">
											<p class="note">
												<strong>Note:</strong> works in Chrome, Firefox, Opera and
												IE10.
											</p>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<textarea class="form-control" disabled="disabled"
												placeholder="Textarea" rows="4"></textarea>
										</div>
									</div>
								</fieldset>
								...
								<fieldset>
										...
										<div class="col-md-10">
											...
											<div class="checkbox">
												<label> <input type="checkbox" disabled="disabled"
													name="checkbox-3" value=""> Checkbox 1
												</label>
											</div>
											<div class="checkbox">
												<label> <input type="checkbox" disabled="disabled"
													name="checkbox-3" value=""> Checkbox 2
												</label>
											</div>
											<div class="checkbox">
												<label> <input type="checkbox" disabled="disabled"
													name="checkbox-3" value=""> Checkbox 3
												</label>
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-10">
											<label class="checkbox-inline"> <input
												type="checkbox" disabled="disabled" name="checkbox-4"
												value=""> Checkbox 1
											</label> <label class="checkbox-inline"> <input
												type="checkbox" disabled="disabled" name="checkbox-4"
												value=""> Checkbox 2
								...
								<fieldset>
										...
										<div class="col-md-10">
											<div class="radio">
												<label> <input type="radio" disabled="disabled"
													name="radio-3" value=""> Radiobox 1
												</label>
											</div>
											<div class="radio">
												<label> <input type="radio" disabled="disabled"
													name="radio-3" value=""> Radiobox 2
												</label>
											</div>
											<div class="radio">
												<label> <input type="radio" disabled="disabled"
													name="radio-3" value=""> Radiobox 3
												</label>
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-10">
											<label class="radio radio-inline"> <input
												type="radio" disabled="disabled" name="radio-4" value="">
												Radiobox 1
											</label> <label class="radio radio-inline"> <input
												type="radio" disabled="disabled" name="radio-4" value="">
												Radiobox 2
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<input type="file" class="btn btn-default"
												disabled="disabled" id="exampleInputFile2">
											<p class="help-block">some help text here.</p>
										</div>
									</div>
								...
								<fieldset class="demo-switcher-1">
										...
										<div class="col-md-10">
											...
											<div class="checkbox">
												<label> <input type="checkbox"
													...
													disabled="disabled"> <span>Checkbox 1</span>
												</label>
											</div>

											<div class="checkbox">
												<label> <input type="checkbox"
													class="checkbox style-0" disabled="disabled"> <span>Checkbox
														2</span>
												</label>
											</div>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<label class="checkbox-inline"> <input
												type="checkbox" class="checkbox style-0" disabled="disabled">
								...
								<fieldset class="demo-switcher-1">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<div class="radio">
												<label> <input type="radio" class="radiobox style-0"
													checked="checked" disabled="disabled" name="style-0">
													<span>Radiobox 1</span>
												</label>
											</div>
											<div class="radio">
												<label> <input type="radio" class="radiobox style-0"
													disabled="disabled" name="style-0"> <span>Radiobox
														2</span>
												</label>
											</div>
											<div class="radio">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<label class="radio radio-inline"> <input
												type="radio" class="radiobox style-0" disabled="disabled"
												name="style-0a"> <span>Radiobox 1</span>

											</label> <label class="radio radio-inline"> <input
												type="radio" class="radiobox style-0" disabled="disabled"
												name="style-0a"> <span>Radiobox 2</span>
											</label> <label class="radio radio-inline"> <input
												type="radio" class="radiobox style-0" disabled="disabled"
												name="style-0a"> <span>Radiobox 3</span>
											</label>
										</div>
									</div>
								...
								<fieldset>
									...
									<div class="form-group">
										<label class="control-label col-md-2">Extra Small
											Input</label>
										<div class="col-md-10">
											<input class="form-control input-xs" disabled="disabled"
										...
										<div class="col-md-10">
											<div class="row">
												<div class="col-sm-12">
													<div class="input-group">
														<input class="form-control" disabled="disabled"
															type="text"> <span class="input-group-addon">.00</span>
													</div>
												</div>
											</div>
										</div>
													...
													<div class="input-group">
														<span class="input-group-addon"> <span
															class="checkbox"> <label> <input
																	...
																	class="checkbox style-0" checked="checked"> <span></span>
															</label>
														</span>
														</span> <input class="form-control" disabled="disabled"
															placeholder="" type="text">
													</div>
												</div>
											</div>
										...
										<div class="col-md-10">
											<div class="row">
												<div class="col-sm-12">
													<div class="input-group">
														<input class="form-control" disabled="disabled"
															placeholder="With switch" type="text"> <span
															class="input-group-addon"> <span
															class="onoffswitch"> <input type="checkbox"
																name="start_interval" disabled="disabled"
																class="onoffswitch-checkbox" id="st3a"> <label
																class="onoffswitch-label" for="st3a"> <span
											...
											<div class="row">
												<div class="col-sm-12">
													<div class="input-group">
														<span class="input-group-addon"> <span
															class="radio"> <label> <input type="radio"
																	disabled="disabled" class="radiobox style-0"
																	name="style-0t2a"> <span> Left</span>
															</label>
														</span>
														</span> <input class="form-control" disabled="disabled"
															placeholder="" type="text"> <span
															class="input-group-addon"> <span class="radio">
																<label> <input type="radio" disabled="disabled"
																	class="radiobox style-0" name="style-0t2a"> <span>
																		Right</span>
															</label>
														</span>
														</span>
											...
											<div class="row">
												<div class="col-sm-12">
													...
													<div class="input-group">
														...
														<div class="input-group-btn">
															<button type="button" class="btn btn-default"
																tabindex="-1" disabled="disabled">Action</button>
															<button type="button"
																class="btn btn-default dropdown-toggle"
																data-toggle="dropdown" tabindex="-1" disabled="disabled">
																<span class="caret"></span>
															</button>
															<ul class="dropdown-menu pull-right" role="menu">
																<li><a href="javascript:void(0);">Action</a></li>
											...
											<div class="row">
												<div class="col-sm-12">
													...
													<div class="input-group">
														<div class="input-group-btn">
															<button type="button" class="btn btn-default"
																disabled="disabled" tabindex="-1">Action</button>
															<button type="button"
																class="btn btn-default dropdown-toggle"
																disabled="disabled" data-toggle="dropdown" tabindex="-1">
																<span class="caret"></span>
															</button>
															<ul class="dropdown-menu" role="menu">
																<li><a href="javascript:void(0);">Action</a></li>
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<div class="icon-addon addon-lg">
												<input type="text" placeholder="Email" class="form-control"
													disabled="disabled"> <label for="email"
											...
											<div class="row">
												<div class="col-sm-12">
													...
													<div class="input-icon-left">
														<i class="fa fa-microphone"></i> <input
															class="form-control" disabled="disabled"
															placeholder="Left Icon" type="text">
													</div>
