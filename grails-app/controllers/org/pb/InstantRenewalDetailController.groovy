...
class InstantRenewalDetailController {
    ...
    def save(InstantRenewalDetail instantRenewalDetailInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'instantRenewalDetail.label', default: 'InstantRenewalDetail'), instantRenewalDetailInstance.id])
    ...
    def update(InstantRenewalDetail instantRenewalDetailInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'InstantRenewalDetail.label', default: 'InstantRenewalDetail'), instantRenewalDetailInstance.id])
                redirect instantRenewalDetailInstance
            }
    ...
    def delete(InstantRenewalDetail instantRenewalDetailInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'InstantRenewalDetail.label', default: 'InstantRenewalDetail'), instantRenewalDetailInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'instantRenewalDetail.label', default: 'InstantRenewalDetail'), params.id])
                redirect action: "index", method: "GET"
            }
